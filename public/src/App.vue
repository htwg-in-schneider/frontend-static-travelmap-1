...
<template>
  ...
  <section id="warum" class="min-h-screen flex items-center px-6 bg-white">
    <div class="max-w-6xl mx-auto w-full">
      <h2 class="text-3xl md:text-4xl font-bold text-left text-gray-900 mb-16">
        Warum MapMyJourney?
      </h2>
  ...
  <section id="features" class="min-h-screen flex items-center px-6">
    <div class="max-w-6xl mx-auto w-full">
      <h2 class="text-3xl md:text-4xl font-bold text-left text-gray-900 mb-16">Features</h2>
      <div class="grid md:grid-cols-3 gap-10">
        <!-- Feature 1 -->
        <div class="text-center border border-blue-200 rounded-xl p-8">
          <div class="w-16 h-16 mx-auto mb-4 bg-blue-100 rounded-full flex items-center justify-center">
            <img :src="globeHeroSvg" alt="Globus" class="w-8 h-8" />
          </div>
          <h3 class="font-bold text-gray-900 mb-2">Interaktiver 3D-Globus</h3>
        ...
        <div class="text-center border border-blue-200 rounded-xl p-8">
          ...
          <h3 class="font-bold text-gray-900 mb-2">Alles an einem Ort</h3>
          <p class="text-sm text-gray-500">
        ...
        <div class="text-center border border-blue-200 rounded-xl p-8">
          ...
          <h3 class="font-bold text-gray-900 mb-2">Plane deine Reisen</h3>
          <p class="text-sm text-gray-500">
